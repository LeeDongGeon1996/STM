...
function createEditor() {
   ...
   editor = CKEDITOR.replace('editor1', {
      ...
      contentsCss : [ 'https://cdn.ckeditor.com/4.8.0/full-all/contents.css', 'resources/innerEditor.css'],
      ...
      height : '297mm',
      width : '230mm'
    	  //내부크기가 210mm이라서 에디터 크기는 살짝 더 크게
   });
   
   
   
   CKEDITOR.scriptLoader.load('resources/pagenation.js', function(success){
