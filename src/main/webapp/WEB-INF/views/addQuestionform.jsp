...
<script type="text/javascript">
	function createNewEditor(){
		...
		document.getElementById("secondEditor").append(editor);
					...
					<div class="tab-content custom-tab-content">
						<div>
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane fade" id="messages" onclick="createNewEditor()">
									<div class="container-fluid ">
										<div class="row">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"
												style="padding: 0px">
												...
												<form:form modelAttribute="questionVO"
													...
													<div class="filebox2">
														<label for="ex_filename2">이미지 업로드</label> <input
															...
															type="file" name="file2" placeholder="파일 선택"
															onchange="onFileSelected(this.files)"> <input
															class="upload-name2" value="파일선택" disabled="disabled">
													</div>
													<div>
														<label class="label-answer">정답 입력</label> <input
															class="jdInsert" type="text" name="answer" path="answer"
												...
												<div class="outterB rightC" id="editordiv">
													...
													<div id="ck">
														<form name="capimgForm" id="capimgForm"
															...
															method="post">
															<input type="hidden" id="capimgData" name="capimgData">
															<div id="captureDiv secondEditor">
																<br>
															</div>
														</form>
													</div>
