								...
								<li role="presentation" class="active"><a href="#home"
									aria-controls="home" role="tab" data-toggle="tab"><i
										class="glyphicon icon"></i><span class="link-lable">
											객관식</span></a></li>
								<li role="presentation" onclick="location.href='./addQuestion2'"><a
									href="#messages" aria-controls="messages" role="tab"
									data-toggle="tab"><i class="glyphicon"></i><span
										class="link-lable"> 주관식</span></a></li>
							</ul>
													...
													<div class="outterB bottomC">
														<div>
															...
															<form:input path="mulChoiceOne" name="mulChoiceOne"
																...
																id="mulChoice_1" onkeyup="onChoiceChange_1();"
																class="bgInsert" type="text"></form:input>
														</div>
														<div>
															<label style="font-size: 15pt;">②&nbsp</label>
															<form:input path="mulChoiceTwo" name="mulChoiceTwo"
																placeholder="2번 보기" autofocus="" required=""
																id="mulChoice_2" onkeyup="onChoiceChange_2();"
																class="bgInsert" type="text"></form:input>
														</div>
														<div>
															<label style="font-size: 15pt;">③&nbsp</label>
															<form:input path="mulChoiceThree" name="mulChoiceThree"
																...
																id="mulChoice_3" onkeyup="onChoiceChange_3();"
																class="bgInsert" type="text"></form:input>
														</div>
														<div>
															<label style="font-size: 15pt;">④&nbsp</label>
															<form:input path="mulChoiceFour" name="mulChoiceFour"
																...
																id="mulChoice_4" onkeyup="onChoiceChange_4();"
																class="bgInsert" type="text"></form:input>
														</div>
														<div>
															<label style="font-size: 15pt;">⑤&nbsp</label>
															<form:input path="mulChoiceFive" name="mulChoiceFive"
																...
																id="mulChoice_5" onkeyup="onChoiceChange_5();"
																class="bgInsert" type="text"></form:input>
														</div>
													</div>
													<div>
