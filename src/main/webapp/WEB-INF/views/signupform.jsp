            ...
            <form:form modelAttribute="infoVO" action="login" method="POST" onSubmit="return Validate()" name="infos">
              <form class="form-signin">
                ...
                <div class="form-label-group">
                  <form:input path="username" name="username" type="text" class="form-control" placeholder="이름 입력" required="" autofocus=""></form:input>
                  <div id="username_error" class="val_error"> </div>
                </div>
                <!-- 이메일 넣기 -->
                <div class="form-label-group">
                  <form:input path="email" name="email" type="email" class="form-control" placeholder="이메일 입력(ID)" required="" autofocus=""></form:input>
                ...
                <!-- 비밀번호 중복 확인 -->
                <div class="form-label-group">
                  <form:input path="" name="passwordConfirm" type="password" class="form-control" placeholder="비밀번호 재입력" required="" autofocus=""></form:input>
                  <div id="passwordConfirm_error" class="val_error"> </div>
                </div>
                <!-- 생일 -->
                <div class="form-label-group">
                  <form:input path="birth" name="birth" type="date" class="form-control" placeholder="생년월일 입력" required="" autofocus=""></form:input>
                  <div id="birth_error" class="val_error"> </div>
                </div>
                <!-- 주소 -->
                <div class="form-label-group">
                  <form:input path="address" name="address" type="text" class="form-control" placeholder="주소 입력" required="" autofocus=""></form:input>
                  <div id="address_error" class="val_error"> </div>
                </div>
                <!-- 전화번호 -->
                <div class="form-label-group">
                  <form:input path="pNum" name="pNum" type="tel" class="form-control" placeholder="휴대폰 번호 : 숫자로만 입력해 주세요!" required="" autofocus=""></form:input>
