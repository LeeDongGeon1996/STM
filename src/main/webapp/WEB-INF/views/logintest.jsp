                ...
                <div class="col-lg-10 col-xl-9 mx-auto">
                    <div class="card card-signin flex-row my-5">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Page shown-->
                            <form id="infoVO" action="login" method="POST">
                                <form class="form-signin">

                                    <div class="form-label-group">
                                        <input type="email" id="email" class="form-control" placeholder="Type your email" required autofocus>
                                    </div>
                                    <div class="form-label-group">
                                        <input type="password" id="password" class="form-control" placeholder="Type your password" required autofocus>
                                    </div>
                            ...
                            <form id="infoVO" action="getinfo" method="POST">
                                <form class="form-signin">
                                    <div class="form-label-group">
