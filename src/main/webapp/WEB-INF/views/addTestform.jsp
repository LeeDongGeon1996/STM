...
<script src="${pageContext.request.contextPath}/resources/convertPDF.js"></script>


<script src="${pageContext.request.contextPath}/resources/pagenation.js"></script>
...
<script>
   ...
   //setTimeout(function(){testScript();setTimeout(function(){testScript_re();},10000);},5000);
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"
							...
							<div class="div-btn">
								...
								<button class=" btn-save" onclick="aa()">PDF</button>
